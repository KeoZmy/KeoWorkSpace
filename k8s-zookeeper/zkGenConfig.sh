...
function create_config() {
    ...
    echo "server.1=zk-0.zk-headless.platform.svc.cluster.local:2888:3888" >> $ZK_CONFIG_FILE
    echo "server.2=zk-1.zk-headless.platform.svc.cluster.local:2888:3888" >> $ZK_CONFIG_FILE
    echo "server.3=zk-2.zk-headless.platform.svc.cluster.local:2888:3888" >> $ZK_CONFIG_FILE
...
function create_log_props () {
	...
	echo "zookeeper.log.threshold="$ZK_LOG_LEVEL >> $LOGGER_PROPS_FILE
    ...
    echo "log4j.appender.ROLLINGFILE.Threshold=\${zookeeper.log.threshold}" >> $LOGGER_PROPS_FILE
